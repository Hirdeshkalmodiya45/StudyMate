      ...
      <div className="w-full min-h-screen pt-16 md:pt-20 flex flex-col md:flex-row select-none bg-gray-50">
        <div className="md:hidden bg-white shadow-sm px-4 py-3 flex items-center justify-between">
          ...
          <div className="text-right">
            {!loading && <CountdownTimer compact />}
          </div>
        </div>

        <div className="md:hidden px-4 py-2 bg-white border-b flex items-center justify-between">
          <button
            onClick={() => setShowQuestionNav(!showQuestionNav)}
            className="flex items-center gap-2 text-sm font-medium text-pink-600"
          >
          ...
          <button
            className="px-3 py-1.5 rounded-md bg-green-600 text-white text-sm font-semibold"
        ...
        <div className="hidden md:block w-[20%] bg-slate-100 pt-12">
          <div className="text-center">
            {!loading ? <CountdownTimer /> : <p>Loading...</p>}
          </div>
